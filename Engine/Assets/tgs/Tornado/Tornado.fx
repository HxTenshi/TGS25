...
PS_INPUT VS( VS_INPUT input )
{
	...
	float y = Time.y * 0.1f;
	float noisex = Noise3d(float3(input.Pos.y/1000.0f+y, input.Pos.x/1000.0f, 2.3456));
	float noisez = Noise3d(float3(input.Pos.y/1000.0f+y, input.Pos.z/1000.0f, 1.23456));
	input.Pos.x += (noisex * 2 - 0.5) * 10;
	input.Pos.z += (noisez * 2 - 0.5) * 10;
